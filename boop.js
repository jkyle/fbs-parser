...
import createFbs from './middleware/fbs';

const fbs = createFbs(program);


const game = createGame(program, [clear, start, nothing, look, go, take, fbs]);
