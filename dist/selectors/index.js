...
exports.select = exports.setSelector = exports.compose = exports.setPropertyForObject = exports.getPropertyFromObject = undefined;
...
var setSelector = exports.setSelector = function setSelector(initialSelectors) {
  selectors = initialSelectors;
};

var select = exports.select = function select(keyArr, state) {
  return {
    get: function get() {
