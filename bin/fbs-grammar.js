...
(function () {
   ...
   var grammar = {
      ParserRules: [{ "name": "game_object", "symbols": ["name", "props"], "postprocess": function postprocess(d) {
            ...
            return d[0].length ? ' ' : '';
         } }, { "name": "condition", "symbols": ["left", "_", "comparator", "_", "right"], "postprocess": function postprocess(d) {
            return { left: d[0], operator: d[2], right: d[4] };
         } }, { "name": "left", "symbols": ["game_object"], "postprocess": id }, { "name": "right$subexpression$1", "symbols": ["primative"] }, { "name": "right$subexpression$1", "symbols": ["game_object"] }, { "name": "right", "symbols": ["right$subexpression$1"], "postprocess": function postprocess(d) {
            return d[0][0];
            ...
            return d[0].join('');
         } }, { "name": "conditional", "symbols": ["conditional_start", "passage", "conditional_end"], "postprocess": function postprocess(d) {
            return { type: 'condition', condition: d[0], passage: d[1] };
            ...
            return d[2];
         } }, { "name": "action", "symbols": [{ "literal": "-" }, "_", "game_object", "_", "operator", "_", "game_object_or_primative"], "postprocess": function postprocess(d) {
            ...
            return { type: "condition", condition: d[2], actions: d[3].map(function (e) {
                  return e[2];
               }) };
            ...
            return d.join('');
         } }, { "name": "fileType$subexpression$1", "symbols": ["fileType$subexpression$1$string$2"] }, { "name": "fileType$subexpression$1$string$3", "symbols": [{ "literal": "C" }, { "literal": "H" }, { "literal": "A" }, { "literal": "R" }, { "literal": "A" }, { "literal": "C" }, { "literal": "T" }, { "literal": "E" }, { "literal": "R" }], "postprocess": function joiner(d) {
            return d.join('');
         } }, { "name": "fileType$subexpression$1", "symbols": ["fileType$subexpression$1$string$3"] }, { "name": "fileType$subexpression$1$string$4", "symbols": [{ "literal": "P" }, { "literal": "L" }, { "literal": "A" }, { "literal": "Y" }, { "literal": "E" }, { "literal": "R" }], "postprocess": function joiner(d) {
            return d.join('');
         } }, { "name": "fileType$subexpression$1", "symbols": ["fileType$subexpression$1$string$4"] }, { "name": "fileType$subexpression$1$string$5", "symbols": [{ "literal": "G" }, { "literal": "L" }, { "literal": "O" }, { "literal": "B" }, { "literal": "A" }, { "literal": "L" }], "postprocess": function joiner(d) {
            return d.join('');
         } }, { "name": "fileType$subexpression$1", "symbols": ["fileType$subexpression$1$string$5"] }, { "name": "fileType", "symbols": [{ "literal": "@" }, "fileType$subexpression$1"], "postprocess": function postprocess(d) {
            return d[1][0];
