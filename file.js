...
var grammar = {
    ...
    {"name": "action$ebnf$2", "symbols": ["action$ebnf$2", {"literal":"\n"}], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "action$ebnf$3", "symbols": []},
    {"name": "action$ebnf$3", "symbols": ["action$ebnf$3", {"literal":"\n"}], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "action$string$2", "symbols": [{"literal":")"}, {"literal":")"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "action", "symbols": [{"literal":"-"}, "_", "action$ebnf$1", "__", "action$string$1", "action$ebnf$2", "passage", "action$ebnf$3", "action$string$2"], "postprocess": d =>  ({type: "say", passage: d[6]})},
