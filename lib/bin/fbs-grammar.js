...
var grammar = {
    ...
    {"name": "right$string$1", "symbols": [{"literal":"$"}, {"literal":"I"}, {"literal":"N"}, {"literal":"P"}, {"literal":"U"}, {"literal":"T"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "right", "symbols": ["right$string$1"], "postprocess": d => ({type: 'INPUT'})},
    ...
    {"name": "object_property$string$3", "symbols": [{"literal":"$"}, {"literal":"I"}, {"literal":"N"}, {"literal":"P"}, {"literal":"U"}, {"literal":"T"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "object_property", "symbols": ["object_property$string$2", "_", "object_property$string$3", "__", {"literal":"}"}], "postprocess": d => ({ type: 'INPUT' })},
    ...
    {"name": "expression_or_primative$string$1", "symbols": [{"literal":"$"}, {"literal":"I"}, {"literal":"N"}, {"literal":"P"}, {"literal":"U"}, {"literal":"T"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "expression_or_primative", "symbols": ["expression_or_primative$string$1"], "postprocess": d => ({type: 'INPUT'})},
