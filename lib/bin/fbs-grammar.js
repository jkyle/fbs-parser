...
var grammar = {
    ...
    {"name": "expression_or_primative$string$1", "symbols": [{"literal":"R"}, {"literal":"A"}, {"literal":"W"}, {"literal":"$"}, {"literal":"T"}, {"literal":"A"}, {"literal":"R"}, {"literal":"G"}, {"literal":"E"}, {"literal":"T"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "expression_or_primative", "symbols": ["expression_or_primative$string$1"], "postprocess": d => ({type: 'RAW_TARGET'})},
    ...
    {"name": "fileType$ebnf$1", "symbols": [/[A-Z]/]},
    {"name": "fileType$ebnf$1", "symbols": ["fileType$ebnf$1", /[A-Z]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "fileType", "symbols": [{"literal":"@"}, "fileType$ebnf$1"], "postprocess": d => d[1].join('')},
