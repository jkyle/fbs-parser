...
var grammar = {
    Lexer: undefined,
    ParserRules: [
    {"name": "comment", "symbols": [{"literal":"#"}, "commentchars"]},
    ...
    {"name": "primative_no_num$subexpression$1", "symbols": ["string"]},
    {"name": "primative_no_num$subexpression$1", "symbols": ["boolean"]},
    {"name": "primative_no_num", "symbols": ["primative_no_num$subexpression$1"], "postprocess": d => d[0][0]},
    ...
    {"name": "__", "symbols": ["__$ebnf$1"], "postprocess": d => d[0].length ? ' ' : ''},
    ...
    {"name": "expression", "symbols": ["AddSub"], "postprocess": id},
    {"name": "Paren", "symbols": [{"literal":"("}, "__", "AddSub", "__", {"literal":")"}], "postprocess": d => d[2]},
    {"name": "Paren", "symbols": ["value"], "postprocess": id},
    {"name": "MulDivMod", "symbols": ["MulDivMod", "__", "mulDivModOp", "__", "Paren"], "postprocess": d => ({ left: d[0], operator: d[2], right: d[4]})},
    {"name": "MulDivMod", "symbols": ["Paren"], "postprocess": id},
    {"name": "AddSub", "symbols": ["AddSub", "__", "addSubOp", "__", "MulDivMod"], "postprocess": d => ({ left: d[0], operator: d[2], right: d[4]})},
    {"name": "AddSub", "symbols": ["MulDivMod"], "postprocess": id},
    {"name": "value$subexpression$1", "symbols": ["number"]},
    {"name": "value$subexpression$1", "symbols": ["game_object"]},
    {"name": "value$subexpression$1", "symbols": ["string"]},
    {"name": "value", "symbols": ["value$subexpression$1"], "postprocess": d => d[0][0]},
    {"name": "mulDivModOp$subexpression$1", "symbols": ["mul"]},
    {"name": "mulDivModOp$subexpression$1", "symbols": ["div"]},
    {"name": "mulDivModOp$subexpression$1", "symbols": ["mod"]},
    {"name": "mulDivModOp", "symbols": ["mulDivModOp$subexpression$1"], "postprocess": d => d[0][0]},
    {"name": "addSubOp$subexpression$1", "symbols": ["plus"]},
    {"name": "addSubOp$subexpression$1", "symbols": ["minus"]},
    {"name": "addSubOp", "symbols": ["addSubOp$subexpression$1"], "postprocess": d => d[0][0]},
    {"name": "plus", "symbols": [{"literal":"+"}], "postprocess": id},
    {"name": "minus", "symbols": [{"literal":"-"}], "postprocess": id},
    {"name": "mul", "symbols": [{"literal":"*"}], "postprocess": id},
    {"name": "div", "symbols": [{"literal":"/"}], "postprocess": id},
    {"name": "mod", "symbols": [{"literal":"%"}], "postprocess": id},
    ...
    {"name": "right", "symbols": ["expression_or_primative"], "postprocess": id},
    {"name": "right$string$1", "symbols": [{"literal":"R"}, {"literal":"A"}, {"literal":"W"}, {"literal":"$"}, {"literal":"T"}, {"literal":"A"}, {"literal":"R"}, {"literal":"G"}, {"literal":"E"}, {"literal":"T"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "right", "symbols": ["right$string$1"], "postprocess": d => ({type: 'RAW_TARGET'})},
    ...
    {"name": "comparator$subexpression$1", "symbols": ["lacks"]},
    ...
    {"name": "lacks", "symbols": ["lacks$subexpression$1"], "postprocess": d => "lacks"},
    ...
    {"name": "line", "symbols": ["__", "first_token", "__"], "postprocess": d => ({ tokens: d[1] })},
    {"name": "first_token", "symbols": ["condition_token"], "postprocess": id},
    {"name": "first_token", "symbols": ["property_token"], "postprocess": id},
    {"name": "first_token", "symbols": ["string_token"], "postprocess": id},
    {"name": "rest_token", "symbols": ["condition_token"], "postprocess": id},
    {"name": "rest_token", "symbols": ["property_token"], "postprocess": id},
    ...
    {"name": "string_token$ebnf$2", "symbols": ["sp_token_1"], "postprocess": id},
    {"name": "string_token$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "string_token", "symbols": ["safeToken", "string_token$ebnf$1", "string_token$ebnf$2"], "postprocess": d => [[d[0], ...d[1].map(e => e[1])].join(' '), ...(d[2] ? d[2] : [])]},
    {"name": "condition_token$ebnf$1", "symbols": ["sp_token"], "postprocess": id},
    {"name": "condition_token$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "condition_token", "symbols": ["conditional", "condition_token$ebnf$1"], "postprocess": d => [d[0], ...(d[1] ? d[1] : [])]},
    {"name": "property_token$ebnf$1", "symbols": ["sp_token"], "postprocess": id},
    {"name": "property_token$ebnf$1", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "property_token", "symbols": ["object_property", "property_token$ebnf$1"], "postprocess": d => [d[0], ...(d[1] ? d[1] : [])]},
    {"name": "sp_token_1$subexpression$1", "symbols": ["condition_token"]},
    {"name": "sp_token_1$subexpression$1", "symbols": ["property_token"]},
    {"name": "sp_token_1", "symbols": ["__", "sp_token_1$subexpression$1"], "postprocess": d => [d[0], ...d[1][0]]},
    {"name": "sp_token$subexpression$1", "symbols": ["condition_token"]},
    {"name": "sp_token$subexpression$1", "symbols": ["string_token"]},
    {"name": "sp_token$subexpression$1", "symbols": ["property_token"]},
    {"name": "sp_token", "symbols": ["__", "sp_token$subexpression$1"], "postprocess": d => [d[0], ...d[1][0]]},
    ...
    {"name": "conditional$ebnf$1$subexpression$1", "symbols": ["condition_else", "passage"]},
    ...
    {"name": "conditional", "symbols": ["conditional_start", "passage", "conditional$ebnf$1", "conditional_end"], "postprocess": d => ({ type: 'condition', condition: d[0], passage: d[1], elsePassage: d[2] ? d[2][1] : null })},
    ...
    {"name": "condition_else$string$1", "symbols": [{"literal":"{"}, {"literal":"~"}, {"literal":"}"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "condition_else", "symbols": ["condition_else$string$1"], "postprocess": id},
    {"name": "object_property$string$1", "symbols": [{"literal":"{"}, {"literal":"@"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "object_property", "symbols": ["object_property$string$1", "_", "expression", "__", {"literal":"}"}], "postprocess": d => d[2]},
    {"name": "object_property$string$2", "symbols": [{"literal":"{"}, {"literal":"@"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "object_property$string$3", "symbols": [{"literal":"R"}, {"literal":"A"}, {"literal":"W"}, {"literal":"$"}, {"literal":"T"}, {"literal":"A"}, {"literal":"R"}, {"literal":"G"}, {"literal":"E"}, {"literal":"T"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "object_property", "symbols": ["object_property$string$2", "_", "object_property$string$3", "__", {"literal":"}"}], "postprocess": d => ({ type: 'RAW_TARGET' })},
    {"name": "action", "symbols": [{"literal":"-"}, "_", "game_object", "_", "operator", "_", "expression_or_primative"], "postprocess": d => ({type: d[4], target: d[2], value: d[6]})},
    ...
    {"name": "expression_or_primative", "symbols": ["expression"], "postprocess": id},
    {"name": "expression_or_primative", "symbols": ["primative_no_num"], "postprocess": id},
    ...
    {"name": "event_block", "symbols": ["__", "method", "event_block$ebnf$1"], "postprocess": d => ({ method: d[1], actions: d[2].map(e => e[2]).filter(e => e)})},
    {"name": "event_block", "symbols": ["comment"], "postprocess": d => null},
    ...
    {"name": "condition_block$ebnf$2$subexpression$1$ebnf$1", "symbols": ["condition_block$ebnf$2$subexpression$1$ebnf$1$subexpression$1"]},
    {"name": "condition_block$ebnf$2$subexpression$1$ebnf$1$subexpression$2", "symbols": [{"literal":"\n"}, "__", "doable"]},
    {"name": "condition_block$ebnf$2$subexpression$1$ebnf$1", "symbols": ["condition_block$ebnf$2$subexpression$1$ebnf$1", "condition_block$ebnf$2$subexpression$1$ebnf$1$subexpression$2"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "condition_block$ebnf$2$subexpression$1", "symbols": [{"literal":"\n"}, "__", "condition_else", "__", "condition_block$ebnf$2$subexpression$1$ebnf$1"]},
    {"name": "condition_block$ebnf$2", "symbols": ["condition_block$ebnf$2$subexpression$1"], "postprocess": id},
    {"name": "condition_block$ebnf$2", "symbols": [], "postprocess": function(d) {return null;}},
    {"name": "condition_block", "symbols": ["condition_start", "_", "condition", "condition_block$ebnf$1", "condition_block$ebnf$2", {"literal":"\n"}, "__", "condition_end"], "postprocess":  d => ({ type: "condition",
        condition: d[2],
    ...
    {"name": "condition_else", "symbols": [{"literal":"~"}]},
    ...
    {"name": "doable", "symbols": ["comment"], "postprocess": d => null},
    {"name": "computed_prop$string$1", "symbols": [{"literal":"("}, {"literal":"("}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "computed_prop$string$2", "symbols": [{"literal":")"}, {"literal":")"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "computed_prop", "symbols": [{"literal":":"}, "props", "__", "computed_prop$string$1", "passage", "computed_prop$string$2"], "postprocess": d => ({ [d[1][0]]: d[4] })},
    ...
    {"name": "file$ebnf$2", "symbols": ["file$ebnf$2$subexpression$1"]},
    {"name": "file$ebnf$2$subexpression$2", "symbols": [{"literal":"\n"}]},
    {"name": "file$ebnf$2", "symbols": ["file$ebnf$2", "file$ebnf$2$subexpression$2"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "file$ebnf$3", "symbols": []},
    {"name": "file$ebnf$3$subexpression$1", "symbols": [{"literal":"\n"}]},
    {"name": "file$ebnf$3", "symbols": ["file$ebnf$3", "file$ebnf$3$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "file", "symbols": ["fileType", {"literal":" "}, "fileName", "file$ebnf$1", "computed_props", "file$ebnf$2", "events", "file$ebnf$3"], "postprocess": d => ({ type: d[0], id: d[2], props: d[4], events: d[6] })},
    ...
    {"name": "computed_props", "symbols": []},
    {"name": "computed_props$ebnf$1", "symbols": []},
    {"name": "computed_props$ebnf$1$subexpression$1", "symbols": [{"literal":"\n"}, "computed_prop"]},
    {"name": "computed_props$ebnf$1", "symbols": ["computed_props$ebnf$1", "computed_props$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "computed_props", "symbols": ["computed_prop", "computed_props$ebnf$1"], "postprocess": d => Object.assign({}, d[0], d[1].reduce((acc, e) => Object.assign({}, acc, e[1]), {}))},
    ...
    {"name": "events", "symbols": ["event_block", "events$ebnf$1"], "postprocess": d => [d[0], ...d[1].map(e => e[2]).filter(e => e)]}
]
  , ParserStart: "files"
}
